...
export default function AirportInput({
  ...
  return (
    <div className="w-full relative">
      <div className="bg-white border-0 rounded-lg px-4 py-2.5 shadow-sm hover:shadow-md focus-within:shadow-md transition-all duration-200 h-14 flex flex-col justify-center">
