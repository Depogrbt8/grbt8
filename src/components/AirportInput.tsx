...
export default function AirportInput({
  ...
  return (
    <div className="w-full relative">
      <div className="bg-white border border-gray-300 rounded-lg px-2.5 py-3 shadow-none hover:border-green-500 focus-within:border-green-500 focus-within:ring-2 focus-within:ring-green-200 transition-all duration-200 h-12 flex flex-col justify-center">
