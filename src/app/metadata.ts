...
export const metadata: Metadata = {
  ...
  description: 'Avrupa\'dan Türkiye\'ye uçak bileti, otel rezervasyonu ve araç kiralama. En uygun fiyatlar, anında rezervasyon, güvenli ödeme ve 7/24 müşteri desteği ile seyahatinizi planlayın.',
  keywords: [
    'uçak bileti',
    'yurt dışı seyahat',
    'otel rezervasyonu',
  ...
  openGraph: {
    ...
    description: 'Avrupa\'dan Türkiye\'ye uçak bileti, otel rezervasyonu ve araç kiralama hizmetleri sunuyoruz. En uygun fiyatlar, anında rezervasyon, güvenli ödeme ve 7/24 destek.',
    images: [
      {
