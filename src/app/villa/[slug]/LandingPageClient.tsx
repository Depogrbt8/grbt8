...
export default function LandingPageClient({ keyword, slug, type }: LandingPageClientProps) {
  ...
  const content = generateLandingPageContent(keyword, 'villa');
        ...
        <section className="bg-gradient-to-r from-green-600 to-green-700 text-white py-16">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl text-green-100 max-w-3xl mx-auto text-center mb-8">
              {keyword} için özel villalar Gurbetbiz'de. Havuzlu, deniz manzaralı, tam donanımlı villalar en uygun fiyatlarla.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <article className="bg-white rounded-lg shadow-md overflow-hidden p-8">
              ...
              <div className="mt-12 p-6 bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200">
                ...
                <p className="text-gray-700 mb-4">
                  Gurbetbiz'de {keyword.toLowerCase()} için en uygun fiyatları bulun. Özel villalar, güvenli rezervasyon, anında onay.
                </p>
                <Link
                  href="/"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">🏊 Özel Havuzlu Villalar</h3>
                <p className="text-gray-600 text-sm">Havuzlu ve deniz manzaralı özel villalar</p>
              </div>
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">🏡 Tam Donanımlı</h3>
                <p className="text-gray-600 text-sm">Mutfak, salon, yatak odaları tam donanımlı</p>
              </div>
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">🔒 Güvenli Rezervasyon</h3>
                <p className="text-gray-600 text-sm">Güvenli ödeme, anında onay garantisi</p>
              </div>
            </div>
          </div>
        </section>
